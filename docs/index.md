# go-ruby-mail documentation

**Pure-Go (CGO=0) MRI-faithful Ruby mail**

`go-ruby-mail/mail` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `mail`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `mail`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`mail`](https://github.com/go-ruby-mail/mail) | the library — Ruby's `mail` in pure Go |
| [`docs`](https://github.com/go-ruby-mail/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-mail.github.io`](https://github.com/go-ruby-mail/go-ruby-mail.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-mail/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-mail/mail](https://github.com/go-ruby-mail/mail).
