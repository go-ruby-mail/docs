...
Contributions are welcome. `go-ruby-mail/mail` is built to a small set of
...
The library is in [`github.com/go-ruby-mail/mail`](https://github.com/go-ruby-mail/mail).
This documentation site is in [`github.com/go-ruby-mail/docs`](https://github.com/go-ruby-mail/docs).
