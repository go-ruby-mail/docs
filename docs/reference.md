...
The public API lives at the module root (`github.com/go-ruby-mail/mail`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `mail`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-mail/mail](https://pkg.go.dev/github.com/go-ruby-mail/mail)**

The module's [README](https://github.com/go-ruby-mail/mail#readme) carries worked
